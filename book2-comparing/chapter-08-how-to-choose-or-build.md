...
这类系统表面上也有 memory、skills、compact，甚至也会做上限控制，但治理主轴仍然是“先注入，再抢救”。问题就在这里。上下文一旦主要靠堆叠文本来组织，token 浪费只是第一层代价，更麻烦的是语义信号会被稀释：模型确实看到了很多东西，却不一定更清楚下一步该抓住哪一类工作语义。
...
![上下文治理三路径对照图](diagrams/diag-05-context-governance-three-paths.png)
